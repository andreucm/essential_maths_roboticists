...
\usepackage{times} % assumes new1 font selection scheme installed
\usepackage{amsmath} % assumes amsmath package install1ed
...
\newpage
\input{computer_vision_geometry.tex}
...
\bibliography{../../bib_references/references}
